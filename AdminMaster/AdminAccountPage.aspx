<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeFile="AdminAccountPage.aspx.cs" Inherits="SampleLogin.AdminMaster.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>&nbsp;<p>&nbsp; &nbsp; &nbsp;<center>
    Current Password&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:TextBox ID="OldPassTextbox" runat="server" Height="21px" Width="174px" BorderColor="Black" OnTextChanged="OldPassTextbox_TextChanged"></asp:TextBox>
